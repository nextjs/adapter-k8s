...
import { resolveRouteHandlerExport, createHandlerLoader } from '../../src/pool-server/handler-loader.js';
...
describe('createHandlerLoader', () => {
  it('loads and caches handler modules', async () => {
    ...
    const manifest = {
      ...
      poolName: 'ssr',
      outputs: {
        '/': { id: '/app/page', filePath: '/app/.next/server/app/page.js', pathname: '/', type: 'APP_PAGE' },
      },
    } as any;
