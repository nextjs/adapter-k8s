...
const BLOCKED = [
  ...
  ["192.0.2.0", "TEST-NET-1 lower bound"],
  ["192.0.2.255", "TEST-NET-1 upper bound"],
  ["192.88.99.1", "deprecated 6to4 relay anycast"],
  ["198.18.0.0", "benchmarking /15 lower bound"],
  ["198.19.255.255", "benchmarking /15 upper bound"],
  ...
  ["3fff::1", "documentation /20 lower bound"],
  ["3fff:fff::1", "documentation /20 upper bound"],
  ["5f00::1", "segment-routing SIDs"],
  ["4000::1", "outside allocated global-unicast space"],
  ["fe80::1", "link-local"],
...
const ALLOWED = [
  ...
  ["192.0.0.9", "globally reachable PCP anycast exception"],
  ["192.0.0.10", "globally reachable TURN anycast exception"],
  ["198.17.255.255", "address immediately below benchmarking /15"],
  ["198.20.0.0", "address immediately above benchmarking /15"],
  ["2606:2800:220:1:248:1893:25c8:1946", "public IPv6"],
  ["2001:4860:4860::8888", "public IPv6"],
  ["2001:1::1", "globally reachable PCP anycast exception"],
  ["2001:3::1", "globally reachable AMT assignment"],
