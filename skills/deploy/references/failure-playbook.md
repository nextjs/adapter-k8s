...
| ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Deployment <name> did not finish rolling out within 120s`         | New pool pods never became Ready (image pull, crash loop, scheduling). The actual wait is `kubectl rollout status --timeout=600s`; "120s" in the message is stale text | `kubectl logs deployment/<name> -n <ns> --tail=40`; `kubectl describe pod` for pull/scheduling events; fix, re-run deploy                                                        |
